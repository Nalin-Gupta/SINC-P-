...
{
$sql=mysqli_query($con,"SELECT password FROM  director where password='".md5($_POST['password'])."' && username='".$_SESSION['alogin']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update director set password='".md5($_POST['newpassword'])."', updationDate='$currentTime' where username='".$_SESSION['alogin']."'");
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Director Change Password</h3>
							</div>
